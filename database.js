      ...
      throw err
        ...
        (err) => {
            if (err) {
                ...
                db.run(insert, ["Company1","12345"])
                db.run(insert, ["Company2","67890"])
            }
        ...
        (err) => {
            if (err) {
                ...
                db.run(insert, [1,"Location1","Country1","City1","Meta1"])
                db.run(insert, [1,"Location2","Country1","City1","Meta2"])
                db.run(insert, [2,"Location3","Country2","City2","Meta3"])
                db.run(insert, [2,"Location4","Country2","City2","Meta4"])
            }
